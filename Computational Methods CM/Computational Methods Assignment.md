...
![Diagram of the planets as a graph](bruteforce_diagram.png){ width=50% }
...
![Process of traversing the graph using a mass-focused greedy strategy](greedy_diagram_new.png){ width=75% }
...
[^24]: Bensmail, J. _et al._ (2019) _‘Backbone colouring and algorithms for TDMA scheduling’_, _Discrete Mathematics & Theoretical Computer Science_, 21(3). doi:10.23638/DMTCS-21-3-24.
...
Bensmail, J. _et al._ (2019) _‘Backbone colouring and algorithms for TDMA scheduling’_, _Discrete Mathematics & Theoretical Computer Science_, 21(3). doi:10.23638/DMTCS-21-3-24.